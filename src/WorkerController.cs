...
namespace Afonsoft.Parallel
{
    internal class WorkerController<T> : WorkerControllerBase where T : WorkerBase, new()
    {
        ...
        public WorkerController(EventHandler<LoggerEventArgs> logger)
        {
            this.worker = new T();
    ...
    internal class WorkerController : WorkerControllerBase 
    {
        ...
        public WorkerController(Worker worker, EventHandler<LoggerEventArgs> logger)
        {
            this.worker = worker;
            this.Worker = (WorkerBase)this.worker;
            this.Logger = logger;
        }
        internal WorkerController(EventHandler<LoggerEventArgs> logger)
        {
